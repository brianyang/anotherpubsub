(function() {
    ...
    document.getElementById('new-todo').addEventListener('keypress', newTodoKeyPressHandler, false)
    // instead of addEventListener to '#new-todo' we can subscribe to everything
    var newTodo = pubsub.subscribe('createNew', newTodoKeyPressHandler())
  ...
  function createNew(){
    ...
    pubsub.publish('keypressTriggered', 1)
		if ( event.keyCode === ENTER_KEY ) {
